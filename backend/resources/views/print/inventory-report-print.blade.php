        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 80px;">Sisa Stok</th>
            ...
            <tbody>
                @forelse($products as $idx => $prod)
                    ...
                    <tr>
                        ...
                        <td><strong>{{ $prod->stock }} Unit</strong></td>
                        <td style="white-space: nowrap; font-weight: 700;">Rp&nbsp;{{ number_format($itemValuation, 0, ',', '.') }}</td>
                        <td>
                            @if($prod->stock <= 0)
                ...
                @empty
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 24px; color: #94a3b8;">Tidak ada produk yang cocok dengan filter.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
