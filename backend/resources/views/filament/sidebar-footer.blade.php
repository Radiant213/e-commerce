<div style="border-top: 1px solid var(--rc-border, #e2e8f0); margin-top: auto;">
    ...
    <div x-show="$store.sidebar.isOpen" style="padding: 12px 16px 16px;">
        <a href="http://localhost:5173" target="_blank" rel="noopener noreferrer" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 14px; background: var(--rc-surface-2, #0f172a); color: var(--rc-text, #ffffff); border: 1px solid var(--rc-border, rgba(255,255,255,0.1)); border-radius: 10px; font-size: 0.8rem; font-weight: 600; text-decoration: none; box-shadow: var(--rc-shadow-sm); transition: all 0.2s ease;">
    ...
    <div x-show="! $store.sidebar.isOpen" style="padding: 12px 6px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
        <a href="http://localhost:5173" target="_blank" rel="noopener noreferrer" title="Buka Web Toko" style="display: flex; align-items: center; justify-content: center; width: 38px; height: 38px; background: var(--rc-surface-2); color: var(--rc-emerald); border: 1px solid var(--rc-border); border-radius: 10px; text-decoration: none; transition: all 0.2s ease;">
